 ...
 *
 * An email sent to the customer when quote is completed.
 *
 * @package     Quotes for WooCommerce/Email Classes
 * @class       QWC_Quote_Complete
 * @extends     WC_Email
 */

/**
 * Quote Complete Email - Customer.
 */
class QWC_Quote_Complete extends WC_Email {
	...
	public function __construct() {
		...
		$this->template_html  = 'emails/quote-complete.php';
		$this->template_plain = 'emails/plain/quote-complete.php';

		// Triggers for this email.
		add_action( 'qwc_quote_complete_notification', array( $this, 'trigger' ) );
	...
	public function trigger( $order_id ) {
		...
		$send_email = apply_filters( 'qwc_quote_complete_email', $send_email, $order_id );
	...
	public function get_default_subject() {
		return __( '[{blogname}] Your Quote is Ready (Order {order_number}) - {order_date}', 'quote-wc' );
	}
	...
	public function get_default_heading() {
		return __( 'Your Quote is Ready - Order #{order_number}', 'quote-wc' );
	}
